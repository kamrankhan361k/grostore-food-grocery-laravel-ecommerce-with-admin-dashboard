<ul class="tt-side-nav searchMenu">
    ...
    <!-- halal -->
    @php
        $halalActiveRoutes = ['admin.appearance.halal.homepage.hero', 'admin.appearance.halal.homepage.topCategories', 'admin.appearance.halal.homepage.aboutUs', 'admin.appearance.halal.homepage.features', 'admin.appearance.halal.homepage.popular', 'admin.appearance.halal.homepage.whyChooseUs', 'admin.appearance.halal.homepage.clientFeedback', 'admin.appearance.halal.homepage.storeClientFeedback', 'admin.appearance.halal.homepage.editClientFeedback', 'admin.appearance.halal.homepage.updateClientFeedback', 'admin.appearance.halal.homepage.deleteClientFeedback', 'admin.appearance.halal.homepage.onSaleProducts', 'admin.appearance.halal.homepage.blogs'];
    @endphp
